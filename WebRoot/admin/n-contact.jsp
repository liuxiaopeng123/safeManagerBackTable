...
HashMap map = dao.select("select * from companyjj where id='2' ").get(0);
%>
<form action="/qgzxmis/mainCtrl?ac=editcontact" name="f1" method="post" onsubmit="return check()">
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" >
  <TBODY>
  <TR>
    <TD   align="center" bgcolor="#FFFFFF" class="STYLE19" width="10%">内容</TD>
    <TD bgcolor="#FFFFFF" class="STYLE19"  height=24><textarea rows="" cols="" name="mt" id="mt"><%=map.get("content") %></textarea></TD></TR>
...
if(suc!=null)
{
 %>
 alert("操作成功");
  location.replace("/qgzxmis/admin/n-contact.jsp");
 <%}%>
 </script>
