	...
	BACKGROUND-IMAGE: none; MARGIN: 0px
                        ...
                        width="100%">
                          ...
                          <TR vAlign=center align=middle>
                            ...
                            <form action="/qgzxmis/mainCtrl?ac=reg" name="f1" method="post" onsubmit="return check()">
                              ...
                              width="100%">
                                ...
                                学号:<input type="text" id="uname" name="uname" >
                           </TD>
                           </TR>
                           <TR>
                                <TD height=21 vAlign=center 
                           ...
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                               	姓名:<input type="text" id="tname" name="tname" >
                           </TD>
                           </TR>
                           <TR>
                           <TR>
                           ...
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                                班级:<input type="text" id="bj" name="bj" >
                           </TD>
                           </TR>
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                                	学院:<input type="text" id="xy" name="xy" >
                           </TD>
                           </TR>
                           ...
                           <script type="text/javascript">
                            function check(){
                            	if(document.getElementById("uname").value==""){
                            		...
                            		alert("班级不能为空");
                            		return false;
                            	}if(document.getElementById("xy").value==""){
                            		alert("学院不能为空");
                            		return false;
                            	}
                            }
...
if(suc!=null)
{
 %>
 alert("操作成功");
  location.replace("/qgzxmis/login.jsp");
 <%}%>
 </script>