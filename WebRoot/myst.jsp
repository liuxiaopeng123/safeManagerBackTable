...
<SCRIPT type=text/javascript src="files/AC_RunActiveContent.js"></SCRIPT>
  ...
  HashMap user = (HashMap)session.getAttribute("user");
    String url="myst.jsp?1=1";
  String key = request.getParameter("key")==null?"":request.getParameter("key");
  String type = request.getParameter("type")==null?"":request.getParameter("type");
  String sql = "select * from active where 1=1 and id in(select stid from joininfo where  studentid='"+user.get("id")+"')";
  if(!key.equals(""))
  {
  url+="&key="+key;
  sql+=" and (pno like'%"+key+"%' or pname like'%"+key+"%' ) ";
  }  
  if(!type.equals("")){
	  url+="&type="+type;
	  sql+=" and (type ='"+type+"' ) ";
                ...
                <TD>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width=745>
                    ...
                    <TR>
                      ...
                      width=150 align=middle>我参与的工作</TD>
