	...
	BACKGROUND-IMAGE: none; MARGIN: 0px
                        ...
                        width="100%">
                          ...
                          <TR vAlign=center align=middle>
                            ...
                            <form action="/qgzxmis/mainCtrl?ac=upmyinfo" name="f1" method="post" onsubmit="return check()">
                           ...
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                                重复密码:<input type="password" id="upass1" name="upass1" >
                           </TD>
                           </TR>
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                               	姓名:<input type="text" id="tname" name="tname" value="<%=map.get("tname") %>" >
                           </TD>
                           </TR>
                           <TR>
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                                电话:<input type="text" id="tel" name="tel" value="<%=map.get("tel") %>">
                           </TD>
                           </TR>
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                                班级:<input type="text" id="bj" name="bj" value="<%=map.get("bj") %>">
                           </TD>
                           </TR>
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                                学院:<input type="text" id="xy" name="xy" value="<%=map.get("xy") %>">
                           </TD>
                           </TR>
