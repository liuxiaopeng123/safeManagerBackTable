	...
	BACKGROUND-IMAGE: none; MARGIN: 0px
                        ...
                        width="100%">
                          ...
                          <TR vAlign=center align=middle>
                            ...
                            <form action="/qgzxmis/mainCtrl?ac=regqy" name="f1" method="post" onsubmit="return check()">
                           ...
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                               	企业名称:<input type="text" id="tname" name="tname" >
                           </TD>
                           </TR>
                           <TR>
                           <TR>
                                <TD height=21 vAlign=center 
                                align=left class="lin">
                                联系电话:<input type="text" id="tel" name="tel" >
                           </TD>
                           </TR>
                           <TR>
                                <TD height=21 vAlign=center 
